        ...
        html! {
            <div class="flex w-screen">
                ...
                <div class="grow h-screen flex flex-col">
                    ...
                    <div class="w-full grow overflow-auto border-b-2 border-pink-300">
                        {
                            self.messages.iter().map(|m| {
                                let user = self.users.iter().find(|u| u.name == m.from).unwrap();
                                html!{
                                    <div class="flex items-end w-3/6 bg-pink-100 m-8 rounded-tl-lg rounded-tr-lg rounded-br-lg ">
                    ...
                    <div class="w-full h-14 flex px-3 items-center">
                        <input ref={self.chat_input.clone()} type="text" placeholder="Message" class="block w-full py-2 pl-4 mx-3 bg-pink-100 rounded-full outline-none focus:text-pink-400" name="message" required=true />
